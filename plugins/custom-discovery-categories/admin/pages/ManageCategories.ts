...
import { getCategories, Category } from '../../api/utils/ConfigHelper.js';

export function renderCategoriesTable(categories: Category[]): string {
...
export function renderDashboardHtml(categories: Category[]): string {
  return `
